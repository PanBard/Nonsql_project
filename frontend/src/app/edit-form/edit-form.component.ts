...
import { FormArray, FormBuilder, FormControl, FormGroup, FormsModule, NgForm } from '@angular/forms';
 ...
 <div>
    ...
    <div *ngIf="blocked_state" class="fixed inset-0 z-50 bg-black bg-opacity-80  ">
                ...
                <div class="flex justify-between p-20">
                      <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white text-center">Update product</h2>
                    ...
                    <div class="w-screen p-10">
                          ...
                          <div  class="p-4  mb-5  border-b  border-gray-50 rounded-xl">
                            <h3 class="mt-5  text-xl font-bold text-gray-900 dark:text-white bg-gray-800 p-4 text-center">Main parameters</h3>
                                <div class="grid gap-4 mb-4 sm:grid-cols-5">                              
                                    ...
                                    <input formControlName="{{parameter}}" [(ngModel)]="data_from_parent[parameter]==null ? 'null' : data_from_parent[parameter]"  type="text" name="{{parameter}}"  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" [placeholder]="'Type '+parameter" required="">
                                    </div>
                                </div>
                          </div>                         
                        ...
                        <div formGroupName="contact" class="p-4 mb-5  border-b border-1 border-gray-50 rounded-xl">
                              ...
                              <div class="grid gap-4 mb-4 sm:grid-cols-5">   
                                  ...
                                  <label for="{{parameter}}" class="text-left block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{parameter}}</label>
                                  <input formControlName="{{parameter}}" [(ngModel)]="data_from_parent.contact[parameter]==null ? 'null' :data_from_parent.contact[parameter]" type="text" name="{{parameter}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"  [placeholder]="'Type '+parameter" required="">
                                  </div>
                              </div>
                          </div>
                           ...
                           <div formGroupName="map" class="p-4 mb-5  border-b border-1 border-gray-50 rounded-xl">
                              ...
                              <div class="grid gap-4 mb-4 sm:grid-cols-5">   
                                  ...
                                  <label for="{{parameter}}" class="text-left block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{parameter}}</label>
                                  <input formControlName="{{parameter}}" [(ngModel)]="data_from_parent.map[parameter]==null ? 'null' : data_from_parent.map[parameter]" type="text" name="{{parameter}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"  [placeholder]="'Type '+parameter" required="">
                                  </div>
                              </div>
                          </div>
                         ...
                         <div formGroupName="category" class="p-4 mb-5  border-b border-1 border-gray-50 rounded-xl">
                              ...
                              <div class="grid gap-4 mb-4 sm:grid-cols-5">   
                                  ...
                                  <label for="{{parameter}}" class="text-left block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{parameter}}</label>
                                  <input formControlName="{{parameter}}" [(ngModel)]="data_from_parent.category[parameter]==null ? 'null' :data_from_parent.category[parameter]" type="text" name="{{parameter}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"  [placeholder]="'Type '+parameter" required="">
                                  </div>
                              </div>
                          </div>
                          ...
                          <div formGroupName="location" class="p-4 mb-5  border-b border-1 border-gray-50 rounded-xl">
                              ...
                              <div class="grid gap-4 mb-4 sm:grid-cols-5">   
                                  ...
                                  <label for="{{parameter}}" class="text-left block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{parameter}}</label>
                                  <input formControlName="{{parameter}}" [(ngModel)]="data_from_parent.location.city[parameter]==null ? 'null' :data_from_parent.location.city[parameter]" type="text" name="{{parameter}}"  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"  [placeholder]="'Type '+parameter" required="">
                                  </div>
                              </div>
                          </div>
                            ...
                            <div formGroupName="location" class="p-4 mb-5  border-b border-1 border-gray-50 rounded-xl">
                              ...
                              <div class="grid gap-4 mb-4 sm:grid-cols-5">   
                                  ...
                                  <label for="{{parameter}}" class="text-left block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{parameter}}</label>
                                  <input formControlName="{{parameter}}" [(ngModel)]="data_from_parent.location.region[parameter]==null ? 'null' :data_from_parent.location.region[parameter]" type="text" name="{{parameter}}"  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"  [placeholder]="'Type '+parameter" required="">
                                  </div>
                              </div>
                          </div> 
...
export class EditFormComponent implements OnInit{
  ...
  sendData(data: any) {
    return this.http.post<any>(this.api_url+'/insertOne/'+this.data_from_parent._id, data);
  }

  sendDataToApi(): void {
    if (this.myForm.valid) 
      {
        const data = this.myForm.value; // Dane do wysłania
  ...
  main = ['id', 'url','title','last_refresh_time','created_time','valid_to_time','pushup_time','business','status','partner','offer_type']
  ...
  onSubmit() {
    ...
    if ( confirm("Are you sure you want to UPDATE item of _id : "+this.data_from_parent._id) == true) 
      {
    this.sendDataToApi();
    this.block_screen();
      }
